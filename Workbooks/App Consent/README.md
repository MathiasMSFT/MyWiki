...
Microsoft provides a workbook named "App Consent Audit" which helps you to view and identitfy all consents during a specific period in your tenant.
...
2. Then, copy all datas from the json file here and replace all things
...
4. Validate all thing work and save
...
## how to use it
### Scenario 1
I would like to define some low permissions to "User consent settings" and offer them to consent. Before doing that, I would like identify all used applications where those permissions have not been consented by an admin.
